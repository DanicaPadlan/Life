...
int main() {
    ...
    while(curTest != num_test) {
        ...
        //read in how many CONWAY cells to make
        getline(cin, readLine);
        ...
        //create ConwayCell*
        vector<AbstractCell*> conway_cells;
        ...
        while(curCell != num_cells) {
            ...
            //push back coords and *ConwayCell in order
            coordinates.push_back(current_coordinates);
            conway_cells.push_back(new ConwayCell(true, true));
            curCell++;
        }

        //create Life object to run simulation on
        Life life =  Life(lifeRow, lifeCol, coordinates, conway_cells, true);
        ...
        cout << "*** Life<ConwayCell> " << lifeRow << "x" << lifeCol << " ***" << endl;
